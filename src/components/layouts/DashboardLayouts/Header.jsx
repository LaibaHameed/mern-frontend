    ...
    <div className="flex items-center justify-between py-6 px-6 mb-10 bg-slate-100 shadow-md">
      <div className="flex items-center gap-2">
        ...
        <Link href={DASHBOARD_ROOT}>
          <h1 className="font-serif font-bold cursor-pointer">Admin Dashboard</h1>
        </Link>
        {currentSegment && (
          <>
            <span className="text-xl">/</span>
            <h1 className="text-primary font-serif font-bold cursor-pointer capitalize">{currentSegment}</h1>
          </>
        )}
      </div>
